...
public class StarbucksProducer {
    ...
    public static void main(String[] args) {
        ...
        props.put(ProducerConfig.BATCH_SIZE_CONFIG, 16384); // Розмір пакету
        props.put(ProducerConfig.LINGER_MS_CONFIG, 1); // Час очікування перед відправкою
        ...
        try (KafkaProducer<String, StarbucksProduct> producer = new KafkaProducer<>(props)) {
            ...
            if (args.length > 0) {
                try {
                    ...
                    logger.warn("Невірний формат аргументу. Використовуємо значення за замовчуванням: 5");
                }
            }
